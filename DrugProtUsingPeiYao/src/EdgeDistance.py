...
class EdgeDistance(object):
	...
	# Define tree of dependency types
		...
		self.HieDep['aux:pass'] = 'root>dep>aux>auxpass'
		...
		self.HieDep['nsubj:pass'] = 'root>dep>arg>subj>nsubj>nsubjpass'	# added by XS
		self.HieDep['csubj'] = 'root>dep>arg>subj>csubj'
		self.HieDep['csubjpass'] = 'root>dep>arg>subj>csubj>csubjpass'	# added by JZ
		self.HieDep['csubj:pass'] = 'root>dep>arg>subj>csubj>csubjpass'	# added by XS
		...
		self.HieDep['obl'] = 'root>dep>obl'  # https://universaldependencies.org/u/dep/all.html#al-u-dep/obl, similar to dislocated and vocative
		self.HieDep['obl:npmod'] = 'root>dep>obl>npmod'
		self.HieDep['obl:tmod'] = 'root>dep>obl>tmod'

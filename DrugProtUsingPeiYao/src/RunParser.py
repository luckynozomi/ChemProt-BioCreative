...
for line in IN:
    ...
    arr_01, arr_02 = arr[0].split('.')
    OUT_SEN.write('### {} . {} @\n'.format(arr_01, arr_02))
    OUT_SEN.write(arr[1]+' @\n')
    
OUT_SEN.close()


os.system('java -mx5g -cp "/home/manbish/projects/ChemProt-BioCreative/stanford-corenlp-4.2.2/*" edu.stanford.nlp.parser.nndep.DependencyParser -model edu/stanford/nlp/models/parser/nndep/english_UD.gz -sentenceDelimiter @ -textFile '+prefix+'_sentences_sen.txt -outFile '+prefix+'_sentences_sen.dep -tokenized -escaper edu.stanford.nlp.process.PTBEscapingProcessor')
